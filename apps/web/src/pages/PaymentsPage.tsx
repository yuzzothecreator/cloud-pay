  ...
  return (
    <div className="page-content">
      <header className="page-header">
        <h1>Payments</h1>
        <p className="page-sub">Charge cards, issue refunds, and inspect timelines</p>
      </header>
      ...
      <div className="layout">
        <section className="panel">
          ...
          <form onSubmit={onSubmit} className="form">
            ...
            <label className="full">
              Customer email
              <input value={form.customerEmail} onChange={update("customerEmail")} type="email" required />
            </label>
            <label className="full">
              Card number
